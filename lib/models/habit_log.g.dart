...
void _habitLogSerialize(
  ...
  writer.writeDateTime(offsets[0], object.expectedDate);
...
HabitLog _habitLogDeserialize(
  ...
  object.expectedDate = reader.readDateTime(offsets[0]);
...
extension HabitLogQueryFilter
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> expectedDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> expectedDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> expectedDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> recordedAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> recordedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> recordedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterFilterCondition> recordedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitLogQuerySortBy on QueryBuilder<HabitLog, HabitLog, QSortBy> {
  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> sortByExpectedDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expectedDate', Sort.asc);
    });
  }

  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> sortByExpectedDateDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> sortByRecordedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordedAt', Sort.asc);
    });
  }

  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> sortByRecordedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitLogQuerySortThenBy
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> thenByExpectedDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expectedDate', Sort.asc);
    });
  }

  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> thenByExpectedDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expectedDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> thenByRecordedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordedAt', Sort.asc);
    });
  }

  QueryBuilder<HabitLog, HabitLog, QAfterSortBy> thenByRecordedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordedAt', Sort.desc);
    });
  }
...
extension HabitLogQueryWhereDistinct
  ...
  QueryBuilder<HabitLog, HabitLog, QDistinct> distinctByExpectedDate() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, HabitLog, QDistinct> distinctByRecordedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitLogQueryProperty
  ...
  QueryBuilder<HabitLog, DateTime, QQueryOperations> expectedDateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLog, DateTime, QQueryOperations> recordedAtProperty() {
    return QueryBuilder.apply(this, (query) {
